      double precision a(2000,2000),b(2000),x(2000)
...
c
      ...
      double precision a(lda,1),b(1),norma,ransla
c
      init(1) = 1
      init(2) = 2
      init(3) = 3
...
c
   ...
   60 continue
      ...
      DOUBLE PRECISION FUNCTION RANsla( ISEED )
*
...
*
      RANsla = R*( DBLE( IT1 )+R*( DBLE( IT2 )+R*( DBLE( IT3 )+R*
     $         ( DBLE( IT4 ) ) ) ) )
      RETURN
*
*     End of RANsla
